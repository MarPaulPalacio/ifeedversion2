...
function CreateFormulationModal({
  ...
  */
  ...
  return (
    ...
    >
      <div className="modal-box relative w-11/12 max-w-2xl min-h-[500px] min-w-[350px] max-h-[95%] overflow-x-hidden overflow-y-auto scroll rounded-3xl bg-white md:mt-0">
        {/* Close button */}
        <button
          ...
          <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            (
              <>
                ...
                <div className='form-control w-full space-x-5'>
                  <input 
                    type="checkbox"
                    name="is_pregnant"
